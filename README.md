...
Клиент-серверное приложение для управления заказами в цветочном магазине с полным набором CRUD-операций и расчетом стоимости.
...
- ✅ Отображение цены за единицу и общей суммы по каждой позиции
...
5. Просмотрите автоматически рассчитанную стоимость заказа в плашке под карточкой заказа
6. При необходимости редактируйте или удаляйте заказы и позиции
7. Используйте кнопку "Следующий день" для симуляции перехода времени
